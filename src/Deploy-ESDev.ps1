...
Param(
    ...
    [string]$vNetName = 'TethrDeveopment_USEast2',
    ...
    [string]$vNetClusterSubnetName = 'ElasticSearch',
    
    # Enter Ubuntu admin user
    [string]$ubuntuAdmin = 'tethresadmin',
